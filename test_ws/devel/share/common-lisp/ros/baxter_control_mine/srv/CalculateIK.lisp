...
(cl:defmethod cl:initialize-instance :after ((m <CalculateIK-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalculateIK-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_control_mine-srv:<CalculateIK-request> is deprecated: use baxter_control_mine-srv:CalculateIK-request instead.")))

(cl:ensure-generic-function 'desired_pose-val :lambda-list '(m))
(cl:defmethod desired_pose-val ((m <CalculateIK-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_control_mine-srv:desired_pose-val is deprecated.  Use baxter_control_mine-srv:desired_pose instead.")
  (desired_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalculateIK-request>)))
  ...
  "baxter_control_mine/CalculateIKRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalculateIK-request)))
  "Returns string type for a service object of type 'CalculateIK-request"
  "baxter_control_mine/CalculateIKRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CalculateIK-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CalculateIK-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name baxter_control_mine-srv:<CalculateIK-response> is deprecated: use baxter_control_mine-srv:CalculateIK-response instead.")))

(cl:ensure-generic-function 'joints-val :lambda-list '(m))
(cl:defmethod joints-val ((m <CalculateIK-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader baxter_control_mine-srv:joints-val is deprecated.  Use baxter_control_mine-srv:joints instead.")
  (joints m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CalculateIK-response>)))
  ...
  "baxter_control_mine/CalculateIKResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalculateIK-response)))
  "Returns string type for a service object of type 'CalculateIK-response"
  "baxter_control_mine/CalculateIKResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CalculateIK)))
  ...
  "baxter_control_mine/CalculateIK")