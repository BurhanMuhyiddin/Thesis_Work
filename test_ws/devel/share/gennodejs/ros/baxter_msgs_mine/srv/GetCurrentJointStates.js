...
class GetCurrentJointStatesRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCurrentJointStatesRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCurrentJointStatesRequest
    let len;
    let data = new GetCurrentJointStatesRequest(null);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'baxter_msgs_mine/GetCurrentJointStatesRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCurrentJointStatesRequest(null);
    return resolved;
    }
};

class GetCurrentJointStatesResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCurrentJointStatesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCurrentJointStatesResponse
    let len;
    let data = new GetCurrentJointStatesResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCurrentJointStatesResponse(null);
...
module.exports = {
  Request: GetCurrentJointStatesRequest,
  Response: GetCurrentJointStatesResponse,
  md5sum() { return '9ca061465ef0ed08771ed240c43789f5'; },
  datatype() { return 'baxter_msgs_mine/GetCurrentJointStates'; }
};
