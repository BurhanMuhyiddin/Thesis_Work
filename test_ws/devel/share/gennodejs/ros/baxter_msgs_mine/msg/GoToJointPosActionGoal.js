...
class GoToJointPosActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new GoToJointPosGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoToJointPosGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GoToJointPosGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoToJointPosActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GoToJointPosGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GoToJointPosGoal()
    }
...
module.exports = GoToJointPosActionGoal;
