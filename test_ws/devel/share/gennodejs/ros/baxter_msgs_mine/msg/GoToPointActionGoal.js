...
class GoToPointActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoToPointGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GoToPointGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoToPointActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GoToPointGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GoToPointGoal()
    }
...
module.exports = GoToPointActionGoal;
