...
if("TRUE" STREQUAL "TRUE")
  set(baxter_moveit_config_SOURCE_PREFIX /home/lar/ros/test_ws/src/baxter_moveit_config)
  set(baxter_moveit_config_DEVEL_PREFIX /home/lar/ros/test_ws/devel)
  ...
  set(baxter_moveit_config_INSTALL_PREFIX /home/lar/ros/test_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'burhan <sredinger1996@mail.ru>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lar/ros/test_ws/src/baxter_moveit_config/${idir}'.  ${_report}")
    endif()
