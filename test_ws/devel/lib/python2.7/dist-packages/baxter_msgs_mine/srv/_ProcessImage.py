...
"""autogenerated by genpy from baxter_msgs_mine/ProcessImageRequest.msg. Do not edit."""
import codecs
import sys
...
class ProcessImageRequest(genpy.Message):
  _md5sum = "cdaf8587a43a19caa15d83076f59736b"
...
string frame_id
"""
  __slots__ = ['img','color','limb']
  _slot_types = ['sensor_msgs/Image','string','string']
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from baxter_msgs_mine/ProcessImageResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ProcessImageResponse(genpy.Message):
  _md5sum = "7ce4ca47f8921cc12e7516aac3def722"
  _type = "baxter_msgs_mine/ProcessImageResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64[] extracted_features
bool success
"""
  __slots__ = ['extracted_features','success']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.extracted_features)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.extracted_features))
      _x = self.success
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.extracted_features = s.unpack(str[start:end])
      start = end
      end += 1
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.extracted_features.tostring())
      _x = self.success
      buff.write(_get_struct_B().pack(_x))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.extracted_features = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 1
      (self.success,) = _get_struct_B().unpack(str[start:end])
      self.success = bool(self.success)
...
class ProcessImage(object):
  ...
  _md5sum = '8ddaef76372bb3744b202ff9f1b2b0db'
