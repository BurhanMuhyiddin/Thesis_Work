...
set(MSG_I_FLAGS "-Ibond:/home/lar/ros/rope_ws/src/bond_core/bond/msg;-Istd_msgs:/home/lar/ros/rope_ws/src/std_msgs/msg")
...
get_filename_component(_filename "/home/lar/ros/rope_ws/src/bond_core/bond/msg/Constants.msg" NAME_WE)
add_custom_target(_bond_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bond" "/home/lar/ros/rope_ws/src/bond_core/bond/msg/Constants.msg" ""
)

get_filename_component(_filename "/home/lar/ros/rope_ws/src/bond_core/bond/msg/Status.msg" NAME_WE)
add_custom_target(_bond_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "bond" "/home/lar/ros/rope_ws/src/bond_core/bond/msg/Status.msg" "std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bond)
  install(CODE "execute_process(COMMAND \"/home/lar/miniconda3/envs/rope_processing/bin/python3.9\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/bond\")")
  # install generated code
  install(
