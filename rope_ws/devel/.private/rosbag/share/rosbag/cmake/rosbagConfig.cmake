...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /home/lar/ros/rope_ws/src/ros_comm/rosbag)
  set(rosbag_DEVEL_PREFIX /home/lar/ros/rope_ws/devel/.private/rosbag)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /home/lar/ros/rope_ws/install)
...
if(NOT "/home/lar/ros/rope_ws/src/ros_comm/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/home/lar/ros/rope_ws/src/ros_comm/rosbag/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lar/ros/rope_ws/src/ros_comm/rosbag/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lar/ros/rope_ws/devel/.private/rosbag/lib;/home/lar/ros/rope_ws/devel/lib;/opt/ros/kinetic/lib)
