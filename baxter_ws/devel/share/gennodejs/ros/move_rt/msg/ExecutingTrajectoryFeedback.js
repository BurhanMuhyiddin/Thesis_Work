...
class ExecutingTrajectoryFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecutingTrajectoryFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecutingTrajectoryFeedback(null);
...
module.exports = ExecutingTrajectoryFeedback;
