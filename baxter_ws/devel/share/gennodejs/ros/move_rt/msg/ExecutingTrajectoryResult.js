...
class ExecutingTrajectoryResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecutingTrajectoryResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecutingTrajectoryResult(null);
...
ExecutingTrajectoryResult.Constants = {
  SUCCESSFUL: 0,
  INVALID_GOAL: -1,
  INVALID_JOINTS: -2,
...
module.exports = ExecutingTrajectoryResult;
