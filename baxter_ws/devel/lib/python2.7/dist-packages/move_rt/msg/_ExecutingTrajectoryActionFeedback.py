...
"""autogenerated by genpy from move_rt/ExecutingTrajectoryActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ExecutingTrajectoryActionFeedback(genpy.Message):
  _md5sum = "67446a63b636306740fa43e59f799c78"
  _type = "move_rt/ExecutingTrajectoryActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','move_rt/ExecutingTrajectoryFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecutingTrajectoryActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = move_rt.msg.ExecutingTrajectoryFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = move_rt.msg.ExecutingTrajectoryFeedback()
