...
"""autogenerated by genpy from move_rt/ExecutingTrajectoryActionResult.msg. Do not edit."""
import codecs
import sys
...
class ExecutingTrajectoryActionResult(genpy.Message):
  _md5sum = "bce83d50f7bb28226801436caf0e2043"
  _type = "move_rt/ExecutingTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','move_rt/ExecutingTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecutingTrajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = move_rt.msg.ExecutingTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = move_rt.msg.ExecutingTrajectoryResult()
